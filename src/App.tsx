...
const translations = {
  en: {
    ...
    blog: {
      ...
      desc: 'Strategies, tactics, and insights for scaling your B2B revenue.',
      comingSoon: 'Coming Soon',
      comingSoonDesc: 'We are currently crafting high-value content for you. Check back later!'
    },
    contact: {
  ...
  vi: {
    ...
    blog: {
      badge: 'Góc Nhìn',
      title: 'Blog Tăng Trưởng B2B',
      desc: 'Chiến lược, chiến thuật và góc nhìn chuyên sâu để mở rộng doanh thu B2B của bạn.',
      comingSoon: 'Sắp Ra Mắt',
      comingSoonDesc: 'Chúng tôi đang chuẩn bị những nội dung giá trị cao dành cho bạn. Vui lòng quay lại sau!'
    },
    contact: {
    ...
    footer: {
      ...
      s1: 'Tạo nhu cầu',
      s2: 'Chiến lược ABM',
      s3: 'Quảng cáo trả phí',
      s4: 'SEO & Nội dung',
      s5: 'Vận hành doanh thu (RevOps)',
      company: 'Công ty',
      c1: 'Về chúng tôi',
      c2: 'Case Studies',
      c3: 'Tuyển dụng',
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b border-slate-200">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#services" className="block px-3 py-2 text-slate-600 font-medium hover:text-emerald-600 hover:bg-slate-50 rounded-md">{t.nav.services}</a>
              <a href="#case-studies" className="block px-3 py-2 text-slate-600 font-medium hover:text-emerald-600 hover:bg-slate-50 rounded-md">{t.nav.caseStudies}</a>
              <a href="#testimonials" className="block px-3 py-2 text-slate-600 font-medium hover:text-emerald-600 hover:bg-slate-50 rounded-md">{t.nav.testimonials}</a>
              <button 
                onClick={toggleLang}
              ...
              <a href="#contact" className="block px-3 py-2 text-emerald-600 font-medium hover:bg-emerald-50 rounded-md">{t.nav.getQuote}</a>
            </div>
          </div>
        )}
      </nav>
      ...
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 font-medium text-sm mb-6 border border-emerald-100">
              <span className="flex h-2 w-2 rounded-full bg-emerald-500"></span>
              {t.hero.badge}
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 leading-[1.1] mb-6">
              {t.hero.title}<span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-400">{t.hero.titleAccent}</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed max-w-xl">
              {t.hero.desc}
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact" className="inline-flex justify-center items-center gap-2 bg-emerald-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-200 hover:shadow-emerald-300 hover:-translate-y-0.5">
                {t.hero.ctaPrimary}
                <ArrowRight className="w-5 h-5" />
              </a>
              <a href="#services" className="inline-flex justify-center items-center gap-2 bg-white text-slate-700 border border-slate-200 px-8 py-4 rounded-full font-semibold text-lg hover:bg-slate-50 hover:border-slate-300 transition-all">
                {t.hero.ctaSecondary}
              </a>
            </div>
            <div className="mt-10 flex items-center gap-4 text-sm text-slate-500 font-medium">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <img key={i} className="w-8 h-8 rounded-full border-2 border-white" src={`https://i.pravatar.cc/100?img=${i + 10}`} alt="User avatar" />
                ))}
              </div>
          ...
          >
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-2 relative overflow-hidden">
      ...
      <section className="py-16 border-y border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-70 grayscale hover:grayscale-0 transition-all duration-500 mb-16">
            {[
              ...
              { name: 'Zimlog', logo: 'https://i.ibb.co/2Yqf1gW5/11238279.png' },
              { name: 'cirCO', logo: 'https://i.ibb.co/KPVrND0/images-1.jpg', scaleClass: 'scale-150' },
      ...
      <section id="blog" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-emerald-600 font-semibold tracking-wider uppercase text-sm">{t.blog.badge}</span>
            <h2 className="mt-2 text-3xl md:text-4xl font-extrabold text-slate-900">{t.blog.title}</h2>
            <p className="mt-4 text-xl text-slate-600">{t.blog.desc}</p>
          </div>
          
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-12 text-center max-w-4xl mx-auto">
            <div className="w-16 h-16 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-6">
              <MessageSquare className="w-8 h-8" />
            </div>
            <h3 className="text-2xl font-bold text-slate-900 mb-4">{t.blog.comingSoon}</h3>
      ...
      {/* CTA / Contact Section */}
      <section id="contact" className="py-24 bg-emerald-500 relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="hover:text-white transition-colors">{t.footer.s5}</a></li>
              </ul>
            </div>
